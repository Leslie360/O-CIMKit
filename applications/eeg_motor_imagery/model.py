...
class EEGSpatialTemporalReservoir(nn.Module):
    """
    Spatio-Temporal Volatile Reservoir designed to extract motor imagery ERD features.
    """
    def __init__(self, taus=[1.0, 3.0, 5.0], n_res=128, n_inputs=16, seed=42, device='cpu'):
        super().__init__()
        self.n_res = n_res
        self.taus = taus
        self.device = device
        ...
        for i, tau in enumerate(taus):
            ...
            # Spatial projection matrix (channels -> reservoir nodes)
    ...
    def forward(self, X_batch):
        """
        Processes batch and returns spatial-temporal statistical features.
        """
        ...
        for res in self.reservoirs:
            ...
            # Extract statistics along time dimension
...
class EEGMotorQATClassifier(nn.Module):
    """
    EEG Motor Imagery Readout QAT MLP.
    """
